...
def k_means (points,k):
	...
	while (True & i < 500):
		...
		for list_item in cluster_lists:
			#print " LIST = ",list
			new_centroids.append(find_closest_point(mean_average(list_item),points))
...
print "K Means 1 = ",k_means([(100,100),(-100,-100),(100,-100),(-100,100),
					...
					(900,900),(-900,900),(700,-900),(-900,-900),
