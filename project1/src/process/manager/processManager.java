	...
	public static void main(String[] args) {
		...
		System.out.println(" Calling this :" + args[0] + " :"+ args[1] + " :"+ args[2] + " :");
				 ...
				 try {
					 ...
					 System.err.println("Couldn't get I/O for "+ "the connection to: Aakashs-MacBook-Pro.local.");
					 System.exit(1);
				 }

			     try {
					out.writeObject(new String(" HEY SERVER , CLIENT LOVES YOU\n"));
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}

				 System.out.println("COnnection Established from Server \n");
			}	
			else {
					...
					System.out.println(" Read Line "+ inputLine +" Shows Connection Established\n ");
			} 		 
			...
			if (s2.hasNext()) {
				...
				if (name.equals("ps")) {
					...
					try {
						...
						Class<?> process = Class.forName("processes.GrepProcess");
